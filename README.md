...
This is a complete rewrite of another project you can find ![here](https://github.com/FourcadeL/mosaic) which was itself a fork of ![this project](https://github.com/codebox/mosaic).

The more tiles in the mosaic, the better !
But also, the harder for the poor Python PIL library ...
This rewrite in C is much more efficient so you can make even prettier mosaics 💅 !
